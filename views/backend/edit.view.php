<div class="row-fluid">
    <div class="span12">
        ...
        <h2><?php echo __('Edit product catalog', 'product'); ?></h2>
        <br />
        ...
        echo (
            ...
            Form::hidden('product_price', $item['price']).
                        ...
                        <li>
                            ...
                            <span class="btn btn-file">
                                ...
                                <?php echo Form::file('product_file[]', array('id' => 'product_file'))?>
                                    ...
                                    <a href="#" class="btn fileupload-exists" data-dismiss="fileupload" data-key="<?php echo $item['id'] ?>" data-dir="<?php echo $opt['dir'] . DS ?>" data-action="delProdImg"><?php echo __('Remove', 'product'); ?></a>
                                </div>
                            </div>
                        </li>
                    </ul></div>
